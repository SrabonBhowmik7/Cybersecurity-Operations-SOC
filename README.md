...
![Netplan config ExternalGateway](image3.png)

![Netplan config InternalGateway](image2.png)

![Netplan config UbuntuServer](image4.png)

- IP forwarding enabled on both gateway VMs (net.ipv4.ip_forward=1 in /etc/sysctl.conf)

![IP forwarding configuration](image1.png)
...
![Verification ping and internet access](image5.png)
